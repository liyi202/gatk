...
import org.broadinstitute.hellbender.cmdline.CommandLineProgramValidator;
 ...
 */
public class CommandLineValidatorMain extends Main {

    // The main entry point to run GATK tools in command line validation mode only.
    public static void main(final String[] argv) {
        new CommandLineValidatorMain().validateCommandLine(argv);
    }
    ...
    public void validateCommandLine(final String[] argv) {
        ...
        new CommandLineProgramValidator(program).instanceMain(mainArgs);
    }
}
